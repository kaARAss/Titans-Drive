...
(function () {
  ...
  var TOURS = {
    ...
    'Аренда питбайков': { photos:['img/tours/pitbike-1.webp',{src:'img/tours/pitbike-2.webp',pos:'50% 0%'},{src:'img/tours/pitbike-3.webp',pos:'50% 25%'},{src:'img/tours/pitbike-4.webp',pos:'30% 50%'}], eyebrow:'Аренда · питбайки', meta:[['Формат','Аренда'],['Техника','Питбайк'],['Уровень','Любой'],['1 час','1 800 ₽'],['2 часа','3 000 ₽']], desc:'Компактные и лёгкие питбайки в аренду — максимум веселья на площадке и лёгком бездорожье. Идеально, чтобы попробовать себя в управлении и научиться базе — подходит и детям, и взрослым.', feats:['Лёгкие и манёвренные питбайки','Подходят детям и взрослым','Отличны для обучения базе','Экипировка входит в стоимость','Короткий инструктаж перед стартом','1 час — 1 800 ₽, 2 часа — 3 000 ₽'] }
  };
